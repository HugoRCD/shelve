...
const columns: FooterColumn[] = [
  {
    ...
    children: [
      ...
      { label: 'Releases', to: 'https://github.com/hugorcd/shelve/releases', target: '_blank' },
    ],
  },
  {
    label: 'Resources',
...
<template>
  <USeparator icon="custom:shelve" class="z-20 h-px" />
  ...
  <UFooter :ui="{ top: 'border-b border-default', root: 'bg-default z-10' }">
    ...
    <template #left>
      <div class="font-mono text-xs italic tracking-tight">
