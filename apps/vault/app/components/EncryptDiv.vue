...
<template>
  <CrossedDiv class="h-40">
    <div v-if="encryptedText" ref="encryptionElement" class="encryption absolute left-0 top-0 size-full overflow-hidden break-words font-mono text-xs leading-5 text-(--ui-text-muted)">
