...
<template>
  <component :is="as" class="relative -mb-px -ml-px">
    <div v-if="line" class="h-0.5 w-[300rem] bg-elevated/50 absolute -left-[100rem]" />
    <div v-if="line" class="h-[300rem] w-0.5 bg-elevated/50 absolute -top-[100rem] -left-0.5" />
    ...
    <div v-if="line" class="h-0.5 w-[300rem] -z-1 bg-elevated/50 absolute -right-[100rem]" />
    <div v-if="line" class="h-[300rem] w-0.5 -z-1 bg-elevated/50 absolute -bottom-[100rem] -right-0.5" />
  </component>
</template>
