...
<template>
  <UCard :ui="{ background: 'bg-white dark:bg-neutral-950' }">
    ...
    <form id="createVar" class="flex flex-col gap-4" @submit.prevent="createVariables">
    ...
    <template #footer>
      <div class="flex justify-between gap-4">
        ...
        <UButton color="primary" :loading="createStatus === 'pending'">
          <button form="createVar" type="submit">
            Save
          </button>
        </UButton>
      </div>
